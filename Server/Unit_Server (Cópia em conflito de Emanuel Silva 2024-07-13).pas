...
begin
  try
    ...
    Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', Now) + '-Servidor Desativado');
  except on E: Exception do
    begin
...
begin
  if Application.MessageBox('Deseja realmente fechar o atualizador?','',MB_YESNO+MB_ICONQUESTION) = mrYes then
    begin
      vQuerySIC.Free;
      vQueryConstulta.Free;
      vQueryReuniao.Free;
      vQuerySICWeb.Free;
      vQueryConstultaWeb.Free;
      vQueryTOTVS.Free;
      vQueryUpdate.Free;
      vQueryUpdateSIC.Free;
      Application.Terminate;
    end;
end;
...
begin
  ...
  while not vQuerySIC.Eof do
    begin
      ...
      qUser.Close;
      qUser.SQL.Text := 'SELECT RDB$SET_CONTEXT(''USER_SESSION'',''USUARIOLOGADO'',''Servidor'')';
      qUser.SQL.Add(' FROM RDB$DATABASE');
      qUser.Open;
          ...
          if Trim(vQueryTOTVS.FieldByName('A1_YCLIPRI').AsString) = '' then
            begin
              try
                ...
                begin
                  Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', Now) + ' - Erro ao estabelecer conexão com a VPS: ' + e.Message);
                  dm1.IBDatabase3.Connected := False;
                  dm1.IBDatabase3.Connected := True;
                  Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', Now) + ' - Reestabelecendo conexão.');
                  exit;
                end;
              end;
              ...
              try
                try
                  ...
                  Memo_Log.Lines.Add('Cliente Atualizado em ' + FormatDateTime('DD/MM/YYYY HH:MM:SS', Now)
            ...
            begin
              ...
              try
                try
                  ...
                  Memo_Log.Lines.Add('Endereço de Entrega Atualizado em ' + FormatDateTime('DD/MM/YYYY HH:MM:SS', Now)
                                    + ': ' + lClienteTOTVS + '-' + lNomeClienteTOTVS)
                end;

              except on e : Exception do
                begin
                  Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', Now) + ' - Erro ao atualizar endereço de entrega: ' + e.Message);
                  vQuerySICWeb.Transaction.RollbackRetaining;
                  dm1.IBDatabase1.Connected := False;
                  dm1.IBDatabase1.Connected := True;
    ...
    begin
      try
        ...
        TThread.Synchronize(nil,
          procedure
          begin
            Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-TBDEPARTAMENTO atualizado Cloud->Local: ' +
        ...
        begin
          TThread.Synchronize(nil,
            procedure
            begin
              Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-Erro ao atualizar TBDEPARTAMENTO: ' + E.Message);
            end);
      ...
      try
        ...
        begin
          TThread.Synchronize(nil,
            procedure
            begin
              Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-Erro ao atualizar TBLICITACAO_ADI: ' + E.Message);
            end);
      ...
      try
        ...
        begin
          TThread.Synchronize(nil,
            procedure
            begin
              Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-Erro ao atualizar TBLICITACAO_ENTREGA Local->Cloud: ' + E.Message);
            end);
...
//            pImportaLicitacao(vQueryLocal.FieldByName('LICITACAO_ID').AsString);
        ...
        begin
          TThread.Synchronize(nil,
            procedure
            begin
              Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-Erro ao atualizar TBLICITACAO_ITEM Local->Cloud: ' + E.Message);
            end);
        ...
        try
          ...
          begin
            TThread.Synchronize(nil,
              procedure
              begin
                Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-Erro ao atualizar TBLICITACAO Local->Cloud: ' + E.Message);
              end);
      ...
      try
        ...
        begin
          TThread.Queue(nil,
            procedure
            begin
              Memo_Log.Lines.Add(FormatDateTime('DD/MM/YYYY HH:MM:SS', vlData) + '-Erro ao atualizar TBLICITACAO_ORGAO Local->Cloud: ' + E.Message);
            end);
...
//          pAtualizaPedidoItemLocalToCloud(dm1.IBDatabase1, dm1.IBTransaction1, dm1.IBDatabaseCloudSICFAR, dm1.IBTransactionCloudSICFAR);
          ...
          pAtualizaLicitacaoCloudToLocal(dm1.IBDatabase1, dm1.IBDatabaseCloudSICFAR, dm1.IBTransaction1, dm1.IBTransactionCloudSICFAR, '');
